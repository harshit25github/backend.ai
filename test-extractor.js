...
async function testExtractor() {
  const testResponse = `## 🗺️ Mumbai Itinerary (2 Days)
...
- **Breakfast at Café Madras**: Head to Matunga for some authentic South Indian breakfast (Idli, Dosa, Filter Coffee).

**☀️ Afternoon**
- **Visit Gateway of India**: Explore this iconic arch monument around 11:00 AM. Great photo ops.
- **Take a Ferry to Elephanta Caves**: Ferry departs at 1:00 PM, takes about 1 hour. Entry fee ₹250.
